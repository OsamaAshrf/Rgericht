...
function Intro (){
    ...
    const Object = [
        {title:"The Key To Fine Dining",src:"/Rgericht/assets/pic1.png"},
        {title:"Reserve Your Table Today",src:"/Rgericht/assets/pic2.png"},
        {title:"Food That Surprize You",src:"/Rgericht/assets/pic3.png"},
        {title:"Love The Original Taste",src:"/Rgericht/assets/pic4.png"}
    ];
    ...
    <div className="Intro-container" id="intro" >
        ...
        <div id="tex" className="Text-container">
            ...
            <img src="\Rgericht\assets\spoon.png" className='img'></img>
