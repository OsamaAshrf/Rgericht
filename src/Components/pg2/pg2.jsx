    ...
    <div className='AboutUs2-Container'>
        ...
        <div className='SectionT'>
            <div className='SecL'>
                ...
                <div className='divIm'>
                    <img src="../../src/assets/p.png" style={{width:"100%"}}></img>
                </div>
            </div>
            <div className='SecR'>
                <div className='divIm'>
                    <img src="../../src/assets/pg21.png" className='imgR mb-4' style={{width:"100%"}}></img>
                </div>
                <h5 style={{color:"var(--color-theme-primary)"}} className='overYears'>Over The Years</h5>
                <div className='staticsDiv'>
                    <div className='statics'>
                        <h5>30+</h5>
                        <img className='mb-3' src="../../src/assets/spoon.png" style={{width:"30px"}}/>
                        <p style={{width:"50px"}}>Breakfast Options</p>
                    </div>
                    <div className='bord'></div>
                    <div className='statics'>
                        <h5>50+</h5>
                        <img src="../../src/assets/spoon.png" style={{width:"30px"}}/>
