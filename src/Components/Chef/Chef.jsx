...
function Chef(){
    ...
    <div className="Chef-container">
        <div className="chefPicdev">
            <img src="../../gericht/src/assets/chef.png" style={{width:"100%"}}/>
        </div>
        <div className="chefInfo">
            ...
            <p className="mb-5" style={{color:"rgb(168, 168, 168)",
                fontSize:"0.8rem",
                    ...
                    <span><img className='me-3 mb-2 mt-0' src="../../gericht/src/assets/quote.png" style={{width:"2.3rem"}}/></span>
            ...
            <img src="../../gericht/src/assets/sign.png" style={{width:"10rem"}}/>
        </div>
    </div>
    </div>);
} export default Chef